...
- [ ] **MCP-055** — Mesurer couverture des fichiers utiles, citations valides, octets/tokens, latence et impact sur la qualité du plan. _(Campagne complète : couverture 92 %, citations 100 %, 61 588 caractères MCP contre 86 958 directs, soit -29,2 %. La gate reste ouverte : 5/20 réponses Planner sont mal formées, tous les pipelines ont échoué en aval et la revue Produit/RSSI de non-régression n'est pas acquise.)_
