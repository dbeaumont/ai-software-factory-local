...
- [ ] **MCP-054** — Passer le Planner en `MCP_SHADOW` : comparer le contexte actuel à un contexte reconstruit via outils, sans changer le prompt servi. _(Mode, métriques et générateur de rapport disponibles ; smoke réel réussi le 2026-08-31. Le corpus versionné de 20 tâches Maven/Gradle/npm, les trois fixtures Gitea et le lanceur protégé sont prêts ; l'exécution cloud et la qualification restent requises.)_
