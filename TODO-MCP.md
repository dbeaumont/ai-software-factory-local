...
- [x] **MCP-055** — Mesurer couverture des fichiers utiles, citations valides, octets/tokens, latence et impact sur la qualité du plan. _(Mesures complètes : couverture 92 %, citations 100 % et réduction de 29,2 %. Le schéma strict améliore l'adhérence Planner de 15/20 à 19/20 sur la campagne `20260901-152635`, mais `CTX-020` reste invalide sans `status`. Une reprise applicative, limitée à un seul nouvel appel et instrumentée par `ai_factory_planner_contract_retries`, est maintenant testée localement. Revue technique toujours `NO-GO` jusqu'à une campagne autorisée à 20/20 puis décision Produit/RSSI avant MCP-056.)_
