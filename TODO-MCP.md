...
- [ ] **MCP-017** — Faire relire ADR, menace, permissions et schémas par sécurité et exploitation. _(Dossier, grille de sign-off et pré-revue technique préparés dans `docs/mcp/MCP-017-dossier-revue-securite-exploitation.md` ; 8 écarts sont reliés aux remédiations du plan. `Représentant RSSI` : `APPROVED` ; représentant nommé : `Responsable Exploitation`, décision exploitation et commit examiné encore attendus.)_
