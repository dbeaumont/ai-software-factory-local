...
- [ ] **MCP-180** — Lancer une évaluation A/B sur la suite de référence : réussite au premier patch, réparations, tests, acceptation humaine, tokens, durée et coût. _(Évaluateur fail-closed et format apparié prêts/testés pour 20 cas minimum, avec huit métriques et rejet de toute régression sécurité. Campagne live non exécutée : elle requiert l'autorisation explicite du corpus précis envoyé au fournisseur ; voir `docs/mcp/MCP-180-evaluation-ab.md`.)_
