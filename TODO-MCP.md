...
- [ ] **MCP-017** — Faire relire ADR, menace, permissions et schémas par sécurité et exploitation. _(Dossier et grille de sign-off préparés dans `docs/mcp/MCP-017-dossier-revue-securite-exploitation.md` ; en attente de la décision du `Représentant RSSI` et d'un représentant exploitation/SRE à nommer.)_
