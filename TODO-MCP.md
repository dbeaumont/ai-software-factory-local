...
- [ ] **MCP-055** — Mesurer couverture des fichiers utiles, citations valides, octets/tokens, latence et impact sur la qualité du plan. _(Sur 4 passages : couverture 100 %, citations au format attendu 100 %, mais 15 856 caractères MCP contre 11 160 directs ; le critère de réduction n'est pas validé. Le chemin d'inférence est désormais exclusivement cloud via LiteLLM : la campagne Planner doit être reprise sur cette baseline avant de mesurer une non-régression MCP.)_
