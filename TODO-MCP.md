...
- [ ] **MCP-056** — Basculer Planner puis Developer/PatchRepair sur `MCP_ACTIVE`, rôle par rôle. _(Rollout par allow-list implémenté et testé : canary local préparé avec `planner` seul, Developer conservé en direct ; campagne MCP_ACTIVE à exécuter avant extension.)_
