...
- [x] **MCP-055** — Mesurer couverture des fichiers utiles, citations valides, octets/tokens, latence et impact sur la qualité du plan. _(Mesures complètes : couverture 92 %, citations 100 % et réduction de 29,2 %. Le schéma strict puis la reprise bornée obtiennent encore 19/20 contrats valides sur la campagne `20260901-154935`. La remédiation suivante classe désormais `finish_reason`, refus et filtre sans conserver le contenu, et porte uniquement la seconde tentative Planner à 2 400 tokens ; 80 tests passent. Gate `NO-GO` jusqu'à qualification cloud à 20/20 puis décision Produit/RSSI pour MCP-056.)_
