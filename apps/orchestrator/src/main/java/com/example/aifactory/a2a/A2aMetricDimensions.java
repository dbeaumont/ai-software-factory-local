...
/** Closed metric dimensions; task, workflow, run, context and message identifiers are impossible to add. */
public record A2aMetricDimensions(String role, String skill, String operation, String version, String state) {
