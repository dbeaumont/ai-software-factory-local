...
class AgentCardControllerTest {
    ...
    void publishesOnlyTheActiveRoleAtTheStandardWellKnownLocation() {
        ...
        client.get().uri(AgentCardController.WELL_KNOWN_PATH)
                ...
                .jsonPath("$.supportedInterfaces[0].protocolBinding").isEqualTo("JSONRPC")
                .jsonPath("$.supportedInterfaces[0].protocolVersion").isEqualTo("1.0")
                .jsonPath("$.supportedInterfaces[0].url").isEqualTo("http://agent-developer:8090/a2a")
