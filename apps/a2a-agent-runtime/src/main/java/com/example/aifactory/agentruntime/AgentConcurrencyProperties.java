...
public record AgentConcurrencyProperties(
        ...
        int maxActiveTasksPerTenant, int maxQueuedTasks, Duration workflowDeadlockDetectionTimeout,
    ...
    public AgentConcurrencyProperties {
        if (workflowPollers < 1 || workflowPollers > 32 || activityPollers < 1 || activityPollers > 32
                ...
                || workflowDeadlockDetectionTimeout == null
                || workflowDeadlockDetectionTimeout.compareTo(Duration.ofSeconds(1)) < 0
                || workflowDeadlockDetectionTimeout.compareTo(Duration.ofSeconds(30)) > 0
