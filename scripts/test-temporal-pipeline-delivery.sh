...
requirement=${TEMPORAL_DELIVERY_TEST_REQUIREMENT:-Temporal full delivery verification: add one concise comment immediately before the listsCustomers test without changing behavior.}
