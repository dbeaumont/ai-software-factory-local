...
- [ ] **MAH-011** — Figer une version reproductible du pipeline actuel, des prompts, modèles, images et politiques.
- [ ] **MAH-012** — Rejouer la suite de référence et enregistrer qualité, tests, réparations, tokens, coût, durée et incidents.
...
- [ ] **MAH-017** — Ajouter des cas adversariaux : injection, délégation excessive, conflit de scopes et preuve falsifiée.
...
- [ ] **MAH-034** — Ajouter tous les contrats au catalogue MCP et au mécanisme de validation côté hôte.
- [ ] **MAH-035** — Refuser les champs supplémentaires, identifiants absents, rôles inconnus et références hors tâche.
...
- [ ] **MAH-040** — Introduire un port `WorkflowCoordinator` indépendant de Temporal.
...
- [ ] **MAH-060** — Ajouter Temporal Server et sa persistance à l'environnement Docker Compose local.
