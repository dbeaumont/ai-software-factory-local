...
| `GITEA_TOKEN` injecté comme `AI_FACTORY_GITEA_TOKEN` | orchestrateur | commit, push et création de PR | `scm-delivery-mcp` uniquement | Retirer de l'orchestrateur à MCP-123 ; scope dépôt/PR minimal, rotation et révocation testées. |
