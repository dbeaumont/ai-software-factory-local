...
La campagne A/B autorisée a été exécutée sur 20 cas appariés. Son verdict est **REJECTED** en raison d'une régression du succès des tests et d'une hausse des tokens supérieure au seuil. Le mode d'évaluation reste séparé de l'activation production, limité aux profils locaux et désactivé par défaut. Le rapport complet est dans `docs/qualification/mcp/reports/MCP-180-rapport-campagne-20260902.md`.
