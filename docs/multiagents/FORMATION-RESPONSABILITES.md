...
- `docs/version-1.2.0-archi-04/ETAT-PROTO-1.2.0.md` ;
- `docs/agents/CATALOGUE-AGENTS-V1.md` et `CYCLE-DE-VIE-AGENT.md` ;
- `docs/multiagents/ROUTAGE-REPLANS-CONTRADICTIONS.md` ;
- `docs/multiagents/TASK-MEMORY-EVIDENCE-OPERATIONS.md` ;
- `docs/runbooks/README.md` et `CANARY-KILL-SWITCH-INCIDENT.md`.
