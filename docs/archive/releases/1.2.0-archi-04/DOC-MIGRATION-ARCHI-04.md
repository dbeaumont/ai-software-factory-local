...
([rapport MCP-180](../../../qualification/mcp/reports/MCP-180-rapport-campagne-20260902.md)). Le mode actuel reste donc le chemin de repli et la
...
[rétrodocumentation](../../../overview/current-state.md) distingue leur implémentation de leur activation effective.
